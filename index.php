...
<head>
  ...
  <title>YoLabs Covid-19 Testing Management</title>
...
<body id="page-top">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
    <div class="container">
      <a class="navbar-brand js-scroll-trigger" href="#page-top">YOLABS</a>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-8 mx-auto">
          ...
          <p class="lead">Coronavirus disease (COVID-19) is a newly discovered coronavirus that causes an infectious disease. The majority of individuals infected with the COVID-19 virus will develop a mild to moderate respiratory illness and recover without special treatment. The elderly and those with underlying medical conditions such as cardiovascular disease.</p>
          <p class="lead">The COVID-19 virus spreads primarily through droplets of saliva or nasal discharge when an infected person coughs or sneezes; therefore, it is essential that you practise respiratory etiquette.</p>
...
Reported illnesses have ranged from mild symptoms to severe illness and death</p>
  ...
  <footer class="py-5 bg-dark">
    <div class="container">
      <p class="m-0 text-center text-white">Copyright &copy; Made with love by YoMee</p>
    </div>
    <!-- /.container -->
  </footer>
